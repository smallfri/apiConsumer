...
```bash
curl -X GET -G "/api/1.0.0/redAwning/listing-summaries"     -d "page"="12" \
    -d "limit"="yem0tII5yLQ70NWR" \
    -d "index"="UJCsvGlEc9Z9RdbF" 
```
...
var settings = {
    ...
    "data": {
        "page": 12,
        "limit": "yem0tII5yLQ70NWR",
        "index": "UJCsvGlEc9Z9RdbF"
    },
    "headers": {
    }
}
...
```bash
curl -X POST "/api/1.0.0/redAwning/reservations"     -d "quote_id"="11" \
    -d "first_name"="0Pn2qNij2kXa5jpC" \
    -d "last_name"="SikGl2Dm4DnT2gIR" \
    -d "address"="[]" \
    -d "home_phone"="dkfi9Cz1cT6FFmWJ" \
    -d "mobile_phone"="I9RukNCMMvVNv7ib" \
    -d "email"="ljEnsHBpMum6RwtH" \
    -d "payments"="[]" 
```
...
var settings = {
    ...
    "data": {
        "quote_id": 11,
        "first_name": "0Pn2qNij2kXa5jpC",
        "last_name": "SikGl2Dm4DnT2gIR",
        "address": "[]",
        "home_phone": "dkfi9Cz1cT6FFmWJ",
        "mobile_phone": "I9RukNCMMvVNv7ib",
        "email": "ljEnsHBpMum6RwtH",
        "payments": "[]"
    },
    "headers": {
    }
